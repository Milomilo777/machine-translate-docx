...
- The check_chrome.py script is required to validate that Selenium will work for web engines before execution.
- Use scripts/build.sh and scripts/run-gui.sh for linux environment setups.
...
- از check_chrome.py باید پیش از اجرای موتورهای وب در GUI برای اطمینان از وجود کروم استفاده شود.
- در لینوکس از scripts/build.sh و scripts/run-gui.sh استفاده کنید.
