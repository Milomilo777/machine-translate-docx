...
RUN apt-get update && apt-get install -y --no-install-recommends     wget     gnupg     unzip     curl     xvfb     fonts-liberation     fonts-noto-cjk     fonts-noto-color-emoji     fonts-noto-core     libnss3     libgconf-2-4     libxss1     libappindicator3-1     libasound2     libatk-bridge2.0-0     libgtk-3-0     libgbm1     && rm -rf /var/lib/apt/lists/*
