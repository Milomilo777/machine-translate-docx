...
def test_runner_chatgpt_api_dispatches_to_single_call_path():
    ...
    not the block loop."""
    from runner import selenium_chrome_translate_maxchar_blocks
    ...
    with patch("runner.run_openai_single_call") as mock_single:
...
def test_runner_block_loop_emits_progress_milestones(capsys):
    ...
    with patch("runner.selenium_chrome_deepl_translate") as mock_deepl:
